...
$env:RUN_ID = "gpu"
python3 experiments_v2.py depth_recur --num-unique 4 --num-loops 2
...
$env:RUN_ID = "gpu"
python3 experiments_v2.py depth_recur --num-unique 3 --num-loops 3
...
$env:RUN_ID = "gpu"
python3 experiments_v2.py stacked --edge-mult 3 --mid-mult 2 --conv-kernel 4
...
$env:RUN_ID = "gpu2"
python3 experiments_v2.py stacked --edge-mult 4 --mid-mult 1 --conv-kernel 4
...
$env:RUN_ID = "gpu3"
python3 experiments_v2.py stacked --edge-mult 2 --mid-mult 2 --conv-kernel 2
